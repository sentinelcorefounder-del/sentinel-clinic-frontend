...
export default function SponsorshipManager({ items, records, wallets, capabilities }: {
  ...
  return <div className="space-y-6">
    ...
    {!wallets.length && capabilities.can_operate && <p className="rounded-xl border border-amber-200 bg-amber-50 p-3 text-sm text-amber-900">No eligible Sentinel treasury wallet was returned. Existing clinic, hospital and Afriophthalmics wallets are intentionally not offered here.</p>}
