...
export default function NewEncounterPage() {
  ...
  function handleChange(
    ...
    const value =
      e.target.name === "patient" ? Number(e.target.value) : e.target.value;
  ...
  return (
    <main className="p-10 max-w-2xl">
      ...
      <p className="text-sm text-gray-600 mb-6">
        Encounters must be linked to an existing patient record supplied through Sentinel Ops.
      </p>
